...
/* --------------------------------------------------------------------
   Sayfa her açıldığında her üç bölümü de başlat
   -------------------------------------------------------------------- */
...
window.addEventListener('beforeunload', () => {
  const toplamDogru  = harfDogruSayac;   // harf oyunu + yazma skoru birleşimi
  const toplamYanlis = harfYanlisSayac;
  if (typeof skorKaydet === 'function' && (toplamDogru + toplamYanlis) > 0) {
